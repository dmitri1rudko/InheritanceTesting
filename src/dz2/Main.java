package dz2;
/* Создайте классы Рыбы, Попугая, Кошки, Собаки
 придумайте их свойства(тоесть поля)
 создайте по несколько объектов
 выведите их в консоль
 для задачи данных используйте сеттер можно также конструктор (но желательно сеттер)
 получать через геттер */
public class Main {
